...
Source0:        http://ftp.gnome.org/pub/GNOME/sources/atk/2.28/atk-%{version}.tar.xz
...
rm -f %{buildroot}%{mingw32_libdir}/atk-1.0.def
rm -f %{buildroot}%{mingw64_libdir}/atk-1.0.def
...
%changelog
* Thu Aug 25 2022 Yeti <yeti@gwyddion.net> - 1:2.28.1-3
- added make as BuildRequires
- F36 rebuild

* Wed Mar 23 2022 Yeti <yeti@gwyddion.net> - 1:2.28.1-2
- F34 rebuild

* Tue Feb 23 2021 Yeti <yeti@gwyddion.net> - 1:2.28.1-1
- Started using Epoch
- F32 rebuild
