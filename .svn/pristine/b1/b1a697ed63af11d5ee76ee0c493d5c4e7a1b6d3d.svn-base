...
Patch1:         gtk2-system-python.patch
# https://bugzilla.gnome.org/show_bug.cgi?id=583273
Patch2:         gtk2-icon-padding.patch
# https://bugzilla.gnome.org/show_bug.cgi?id=599618
Patch8:         gtk2-tooltip-positioning.patch
# https://bugzilla.gnome.org/show_bug.cgi?id=611313
Patch15:        gtk2-window-dragging.patch

# Backported from upstream:
Patch20:        gtk2-calendar-Use-the-new-OB-format-if-supported.patch
Patch21:        gtk2-Fix-compiler-warnings-with-GCC-8.1.patch
#https://gitlab.gnome.org/GNOME/gtk/-/merge_requests/2305
Patch23:        gtk2-fix-multiple-definitions.patch
#https://gitlab.gnome.org/GNOME/gtk/-/commit/8a53ed9e55dac8f559fa47f999e527640889659c
Patch24:        gtk2-g-content-type-is-a-NULL.patch

# Retry when OpenClipboard() fails.  And do not abort the program.
# https://bugzilla.gnome.org/show_bug.cgi?id=706610
# (patch modified)
Patch101:        gtk2-win32-openclipboard.patch

# Work around non-existent filter models in file name completion.
Patch102:        gtk+-2.24-file-open-no-filter-model.patch
...
%patch21 -p1 -b .gcc81
%patch23 -p1 -b .gcc10
%patch24 -p1 -b .content-type

%patch101 -p1 -b .openclipboard
%patch102 -p1 -b .file_compl
...
%changelog
* Thu Aug 25 2022 Yeti <yeti@gwyddion.net> - 1:2.24.32-9
- added make as BuildRequires
- F36 rebuild

* Wed Apr 20 2022 Yeti <yeti@gwyddion.net> - 1:2.24.32-8
- g_content_type_is_a assertion fix

* Wed Mar 23 2022 Yeti <yeti@gwyddion.net> - 1:2.24.32-7
- F34 rebuild

* Fri Feb 19 2021 Yeti <yeti@gwyddion.net> - 1:2.24.32-6
- Multiple definitions build fix (gcc10)
- Started using Epoch
- F33 rebuild

* Fri Jan 08 2021 Yeti <yeti@gwyddion.net> - 2.24.32-5
- F32 rebuild

* Mon Feb 10 2020 Yeti <yeti@gwyddion.net> - 2.24.32-3
- F31 rebuild

* Fri May 31 2019 Yeti <yeti@gwyddion.net> - 2.24.32-2
- Update to 2.24.32
- Renumbered our patches to start from 100
- Merged patches 20 and 21 from Fedora 30

* Sat Apr  6 2019 Yeti <yeti@gwyddion.net> - 2.24.31-8
- Work around non-existent filter models in file name completion
- Use explicit python2 shbang

* Tue Aug  8 2017 Yeti <yeti@gwyddion.net> - 2.24.31-7
- F29 rebuild

* Tue Aug  8 2017 Yeti <yeti@gwyddion.net> - 2.24.31-5
- Fixed FSF address

* Thu Mar 9 2017 Yeti <yeti@gwyddion.net> - 2.24.31-4
- Modified OpenClipboard workaround

* Sat Mar 4 2017 Yeti <yeti@gwyddion.net> - 2.24.31-3
- OpenClipboard workaround
