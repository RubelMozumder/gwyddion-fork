...
Patch1:         pango-usp10-gdi32-order.patch
...
%changelog
* Thu Aug 25 2022 Yeti <yeti@gwyddion.net> - 1:1.40.12-9
- added make as BuildRequires
- F36 rebuild

* Wed Mar 23 2022 Yeti <yeti@gwyddion.net> - 1:1.40.12-8
- F34 rebuild

* Fri Feb 19 2021 Yeti <yeti@gwyddion.net> - 1:1.40.12-6
- Started using Epoch
- F33 rebuild
