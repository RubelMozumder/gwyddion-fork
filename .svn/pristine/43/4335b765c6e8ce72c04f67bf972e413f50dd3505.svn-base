...
Patch3:         gtkglext-fix-multiple-definitions.patch
Patch4:         gtkglext-autotools-obsolete.patch
...
%changelog
* Thu Aug 25 2022 Yeti <yeti@gwyddion.net> - 1:1.2.0-11
- updated obsolete autotools constructs to at least make it pass
- added make as BuildRequires
- F36 rebuild

* Wed Mar 23 2022 Yeti <yeti@gwyddion.net> - 1:1.2.0-10
- Started using Epoch
- Fixed multiple definitions (gcc10)
- Rebuilt for F34

* Mon Feb 18 2013 Yeti <yeti@gwyddion.net> - 1.2.0-9
