...
Patch1:         gdk-pixbuf-gif-string-h.patch
...
# Do not package man pages for MinGW
rm -f %{buildroot}%{mingw32_mandir}/man1/*.1
rm -f %{buildroot}%{mingw64_mandir}/man1/*.1
...
%changelog
* Thu Aug 25 2022 Yeti <yeti@gwyddion.net> - 1:2.40.0-3
- F36 rebuild

* Wed Mar 23 2022 Yeti <yeti@gwyddion.net> - 1:2.40.0-2
- F34 rebuild

* Wed Aug 11 2021 Yeti <yeti@gwyddion.net> - 1:2.40.0-1
- Started using Epoch
- F33 rebuild
