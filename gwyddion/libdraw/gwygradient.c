/*
 *  $Id: gwygradient.c 26294 2024-04-24 16:03:24Z yeti-dn $
 ...
 *
 * Returns: Sampled @gradient as a sequence of #GdkPixbuf<!-- -->-like
                  ...
                  GString *str)
{
    ...
    g_assert(sizeof(GwyGradientPoint) == 5*sizeof(gdouble));
    for (i = 0; i < gradient->points->len; i++) {
        GwyGradientPoint *pt = &g_array_index(gradient->points, GwyGradientPoint, i);
                   ...
                   gboolean is_const)
{
    ...
    gradient = gwy_gradient_new("", npoints, (GwyGradientPoint*)data, is_const);
    gwy_gradient_sanitize(gradient);
