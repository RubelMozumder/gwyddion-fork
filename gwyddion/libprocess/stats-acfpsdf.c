/*
 *  $Id: stats-acfpsdf.c 26068 2023-12-20 12:25:29Z yeti-dn $
                          ...
                          gint nstats)
{
    ...
    gwy_data_field_angular_average(re_field, target_line, NULL, GWY_MASK_IGNORE, 0.0, 0.0, r, nstats ? nstats+1 : -1);
    g_object_unref(re_field);
