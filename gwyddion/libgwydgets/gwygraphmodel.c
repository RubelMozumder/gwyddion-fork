/*
 *  $Id: gwygraphmodel.c 26332 2024-05-09 12:05:47Z yeti-dn $
...
gwy_graph_model_new_alike(GwyGraphModel *gmodel)
{
    ...
    g_string_assign(duplicate->title, gmodel->title->str);;
    ...
    gwy_si_unit_assign(duplicate->x_unit, gmodel->x_unit);
    gwy_si_unit_assign(duplicate->y_unit, gmodel->y_unit);
    g_string_assign(duplicate->top_label, gmodel->top_label->str);
    g_string_assign(duplicate->bottom_label, gmodel->bottom_label->str);
    g_string_assign(duplicate->left_label, gmodel->left_label->str);
    g_string_assign(duplicate->right_label, gmodel->right_label->str);
