/*
 *  $Id: sfunctions.c 25590 2023-08-03 09:52:07Z yeti-dn $
...
update_curve(GwyToolSFunctions *tool)
{
    ...
    GwyDataField *mask_to_use = NULL, *field_to_use;
    ...
    if (output_type == GWY_SF_DH) {
        ...
        gwy_data_field_area_racf(field_to_use, tool->line, col, row, w, h, lineres);
