/*
 *  $Id: hitachi-afm.c 25687 2023-09-19 14:44:44Z yeti-dn $
...
/* Note read_data_field() and read_data_field_old() read two completely different file formats, even if they were
