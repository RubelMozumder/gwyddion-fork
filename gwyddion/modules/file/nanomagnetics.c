/*
 *  $Id: nanomagnetics.c 25675 2023-09-18 05:41:59Z yeti-dn $
...
nmi_load(const gchar *filename, G_GNUC_UNUSED GwyRunType mode, GError **error)
{
    ...
    for (channelno = 0; channelno < params.numImages; channelno++) {
        ...
        gwy_container_set_const_string_by_name(container, buf, chparams->Name);
        /* set metadata */
                   ...
                   NMIChannelParameters *chparams)
{
    ...
    gwy_container_set_const_string_by_name(meta, "Name of scan", params->Name);
    gwy_container_set_const_string_by_name(meta, "Info", params->Info);
    ...
    s = gwy_enuml_to_string(params->SpmType,
                            ...
                            "None", SPM_None,
                            NULL);
    gwy_container_set_const_string_by_name(meta, "SPM Type", s ? s : "Unknown");
    ...
    s = gwy_enuml_to_string(params->LaserMode,
                            ...
                            "Efm", LASER_Efm,
                            NULL);
    gwy_container_set_const_string_by_name(meta, "Laser Mode", s ? s : "Unknown");
    ...
    s = gwy_enuml_to_string(params->ScanType,
                            ...
                            NULL);
    gwy_container_set_const_string_by_name(meta, "Scan Type", s ? s : "Unknown");
    ...
    s = gwy_enuml_to_string(params->FeedbackChannel,
                            ...
                            NULL);
    gwy_container_set_const_string_by_name(meta, "Feedback Channel", s ? s : "Unknown");
    ...
    s = gwy_enuml_to_string(params->LtMode,
                            ...
                            "SSRM", LT_SSRM,
                            NULL);
    gwy_container_set_const_string_by_name(meta, "LtMode", s ? s : "Unknown");
    if (params->NMIversion == 3) {
    ...
    if (params->SpmType == SPM_RtShpm
        ...
        gwy_container_set_const_string_by_name(meta, "Software Version", params->SoftwareVersion);
        gwy_container_set_const_string_by_name(meta, "Motor Card Version", params->MotorCardVersion);
        gwy_container_set_const_string_by_name(meta, "Scan DAC Card Version", params->ScanDacCardVersion);
        gwy_container_set_const_string_by_name(meta, "PLL Version", params->PllVersion);
    }
    else if (params->SpmType == SPM_NcAfm) {
        /*NCAFM */
    ...
    if (params->NMIversion == 5) {
        ...
        s = gwy_enuml_to_string(params->LFMDataDisplayMode,
                                ...
                                "Newton", LFM_Newton,
                                NULL);
        gwy_container_set_const_string_by_name(meta, "LFMDataDisplayMode", s ? s : "Unknown");
    }
