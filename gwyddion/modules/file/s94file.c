/*
 *  $Id: s94file.c 26180 2024-02-15 16:06:36Z yeti-dn $
 ...
 * <mime-type type="application/x-s94-stm">
 *   <comment>S94 STM data file</comment>
 *   <glob pattern="*.s94"/>
 *   <glob pattern="*.S94"/>
 * </mime-type>
 **/
         ...
         GError **error)
{
    ...
    dfield = gwy_data_field_new(s94file.xres, s94file.yres,
                                s94file.xreal * Nanometre, s94file.yreal * Nanometre,
                                FALSE);
    ...
    title = gwy_enuml_to_string(s94file.mode,
                                ...
                                "Current", S94_CURRENT,
                                NULL);
    gwy_container_set_const_string(container, gwy_app_get_data_title_key_for_id(0), title ? title : "Unknown");
                ...
                GError **error)
{
    ...
    if (err_DIMENSION(error, s94file->xres) || err_DIMENSION(error, s94file->yres))
        return FALSE;
    ...
    sanitise_real_size(&s94file->xreal, "x size");
    sanitise_real_size(&s94file->yreal, "y size");
...
s94_get_meta(const S94File *s94file)
{
    ...
    gwy_container_set_string_by_name(meta, "Image number (original)", g_strdup_printf("%u", s94file->orig_imageno));
    gwy_container_set_string_by_name(meta, "Image mode", g_strdup_printf("%u", s94file->mode));
    gwy_container_set_string_by_name(meta, "X points", g_strdup_printf("%u", s94file->xres));
    gwy_container_set_string_by_name(meta, "Y points", g_strdup_printf("%u", s94file->yres));
    gwy_container_set_string_by_name(meta, "X size", g_strdup_printf("%g nm", s94file->xreal));
    gwy_container_set_string_by_name(meta, "Y size", g_strdup_printf("%g nm", s94file->yreal));
    gwy_container_set_string_by_name(meta, "X offset", g_strdup_printf("%g nm", s94file->xoff));
    gwy_container_set_string_by_name(meta, "Y offset", g_strdup_printf("%g nm", s94file->yoff));
    gwy_container_set_const_string_by_name(meta, "X/Y swapped", s94file->swapxy ? "Yes" : "No");
    gwy_container_set_string_by_name(meta, "Scan angle", g_strdup_printf("%u deg", s94file->angle));
    gwy_container_set_string_by_name(meta, "Scan speed", g_strdup_printf("%g nm/s", s94file->scanspeed));
    gwy_container_set_string_by_name(meta, "Z gain", g_strdup_printf("%u", s94file->zgain));
    gwy_container_set_string_by_name(meta, "Section", g_strdup_printf("%u", s94file->section));
    gwy_container_set_string_by_name(meta, "Kp", g_strdup_printf("%g", s94file->Kp));
    gwy_container_set_string_by_name(meta, "Tn", g_strdup_printf("%g", s94file->Tn));
    gwy_container_set_string_by_name(meta, "Tv", g_strdup_printf("%g", s94file->Tv));
    gwy_container_set_string_by_name(meta, "It", g_strdup_printf("%g", s94file->It));
