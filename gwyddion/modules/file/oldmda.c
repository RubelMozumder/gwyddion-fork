/*
 *  $Id: oldmda.c 26168 2024-02-08 10:18:02Z yeti-dn $
...
oldmda_read_data(OldMDAFile *mdafile, const gchar *buffer)
{
    ...
    gwy_container_set_const_string_by_name(mdafile->data, "/brick/0/title",
                                           "MDA data");
