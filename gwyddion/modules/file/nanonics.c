/*
 *  $Id: nanonics.c 25680 2023-09-18 16:35:33Z yeti-dn $
              ...
              GError **error)
{
    ...
    s = gwy_convert_to_utf8(header, header_size, "ISO-8859-1");
    if (s) {
        g_free(header);
        header = s;
