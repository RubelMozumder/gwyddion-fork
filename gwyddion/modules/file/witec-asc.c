/*
 *  $Id: witec-asc.c 26163 2024-02-06 16:56:55Z yeti-dn $
         ...
         GError **error)
{
    ...
    xyunit = gwy_si_unit_new_parse(g_hash_table_lookup(hash, "ScanUnit"), &power10xy);
    zunit = gwy_si_unit_new_parse(g_hash_table_lookup(hash, "DataUnit"), &power10z);
