/*
 *  $Id: dmefile.c 25677 2023-09-18 15:38:20Z yeti-dn $
         ...
         GError **error)
{
    ...
    dfield = gwy_data_field_new(dmefile.xres, dmefile.yres, Angstrom*dmefile.xreal, Angstrom*dmefile.yreal, FALSE);
    ...
    if (dmefile.title[0])
        gwy_container_set_const_string(container, gwy_app_get_data_title_key_for_id(0), dmefile.title);
    else
