/*
 *  $Id: stmprg.c 26163 2024-02-06 16:56:55Z yeti-dn $
                ...
                GError **error)
{
    ...
    if (err_DIMENSION(error, mainfield->points) || err_DIMENSION(error, mainfield->lines))
        return FALSE;
                    ...
                    gint bpp)
{
    ...
    gwy_convert_raw_data(buffer, n, 1, rawtypes[bpp], GWY_BYTE_ORDER_BIG_ENDIAN, data, gwy_powi(1.0/256.0, bpp), 0.0);
    return TRUE;
}
