/*
 *  $Id: assing-afm.c 25672 2023-09-15 09:13:54Z yeti-dn $
          ...
          GError **error)
{
    ...
    sanitise_real_size(&afmfile.real, "size");
    rawfield = gwy_data_field_new(afmfile.res, afmfile.res, afmfile.real, afmfile.real, FALSE);
    gwy_convert_raw_data(p, afmfile.res*afmfile.res, 1, GWY_RAW_DATA_SINT16, GWY_BYTE_ORDER_LITTLE_ENDIAN,
            ...
            GError **error)
{
    ...
    z.f = MIN(gwy_data_field_get_xreal(dfield), gwy_data_field_get_yreal(dfield))/Angstrom;
