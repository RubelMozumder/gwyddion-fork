/*
 *  $Id: dm3file.c 26163 2024-02-06 16:56:55Z yeti-dn $
    ...
    */
    ...
    for (j = 0; j < nfields; j++) {
        ...
        if (meta) {
            ...
            gwy_container_pass_object(container, gwy_app_get_data_meta_key_for_id(*id), mymeta);
        }
...
create_meta(gpointer hkey, gpointer hvalue, gpointer user_data)
{
    ...
    ukey = gwy_convert_to_utf8(strkey+1, -1, "ISO-8859-1");
