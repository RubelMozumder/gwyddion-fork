/*
 *  $Id: accurexii-txt.c 26163 2024-02-06 16:56:55Z yeti-dn $
          ...
          GError **error)
{
    ...
    if (!gwy_parse_doubles(p, gwy_data_field_get_data(dfield), GWY_PARSE_DOUBLES_FREE_FORM, &yres, &xres, NULL, &err)) {
...
{
    gwy_container_set_const_string_by_name(GWY_CONTAINER(user_data), (gchar*)hkey, hvalue);
}
