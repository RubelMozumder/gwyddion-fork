/*
 *  $Id: zeiss.c 26163 2024-02-06 16:56:55Z yeti-dn $
...
zeiss_load_tiff(const GwyTIFF *tiff, GError **error)
{
    ...
    gwy_container_set_const_string(container, gwy_app_get_data_title_key_for_id(0), "Secondary electron count");
...
add_meta(gpointer hkey, gpointer hvalue, gpointer user_data)
{
    ...
    if (value)
        gwy_container_set_string_by_name(GWY_CONTAINER(user_data), (gchar*)hkey, value);
}
