/*
 *  $Id: cmap_polylevel.c 26117 2024-01-07 17:44:59Z yeti-dn $
...
define_module_params(void)
{
    ...
    /* Keep calling it order for compatibility. */
    gwy_param_def_add_int(paramdef, PARAM_DEGREE, "order", _("_Degree"), 0, 5, 2);
...
execute(ModuleArgs *args)
{
    ...
    gdouble from = gwy_params_get_double(params, PARAM_RANGE_FROM);
    gdouble to = gwy_params_get_double(params, PARAM_RANGE_TO);
    gint degree = gwy_params_get_int(params, PARAM_DEGREE);
    ...
    for (k = 0; k < xres*yres; k++) {
        ...
        do_polylevel(cdx, cdy, ncdy, ndata, segments, segment, segment_enabled, from, to, degree, TRUE, NULL);
                  ...
                  gint nsegments, const gint *segments)
{
    ...
    do_polylevel(xdata, ydata, NULL, ndata, segments, segment, segment_enabled, from, to, degree, FALSE, fitparams);
}
