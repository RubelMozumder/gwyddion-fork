/*
 *  $Id: fft_filter_2d.c 25638 2023-09-07 12:23:28Z yeti-dn $
...
run_main(GwyContainer *data, GwyRunType run)
{
    ...
    mfield = gwy_data_field_new_alike(fft, TRUE);
    ...
    gwy_container_pass_object_by_name(controls.mydata, "/0/mask", mfield);
    ...
    gwy_container_pass_object_by_name(controls.mydata, "/2/data", filtered);
    ...
    gwy_container_pass_object_by_name(controls.mydata, "/3/data", diff);
                ...
                GwyDataField *field, GwyDataField *mask)
{
    if (field) {
        ...
        field = zoom_in(field);
        gwy_container_pass_object_by_name(container, "/zoomed/4", field);

        field = zoom_in(field);
        gwy_container_pass_object_by_name(container, "/zoomed/16", field);
    }
    ...
    if (mask) {
        ...
        mask = zoom_in(mask);
        gwy_container_pass_object_by_name(container, "/zoomed-mask/4", mask);

        mask = zoom_in(mask);
        gwy_container_pass_object_by_name(container, "/zoomed-mask/16", mask);
    }
}
