...
Patch1:         glib2-Use-CreateFile-on-Win32-to-make-sure-g_unlink-always.patch
...
Patch8:         glib2-GNetworkMonitorBase-don-t-fail-when-IPv6-support-is-unavailable.patch
Patch9:         glib2-fix-multiple-definitions.patch
...
MINGW_BUILDDIR_SUFFIX=_static %mingw_configure --with-python=%{__python3} --disable-shared --enable-static --disable-compile-warnings
MINGW_BUILDDIR_SUFFIX=_shared %mingw_configure --with-python=%{__python3} --disable-static --disable-compile-warnings
...
%install
MINGW_BUILDDIR_SUFFIX=_static %mingw_make install DESTDIR=%{buildroot}/build_static
MINGW_BUILDDIR_SUFFIX=_shared %mingw_make install DESTDIR=%{buildroot}

# Move the static libraries to the right location
mv %{buildroot}/build_static%{mingw32_libdir}/*.a $RPM_BUILD_ROOT%{mingw32_libdir}
mv %{buildroot}/build_static%{mingw64_libdir}/*.a $RPM_BUILD_ROOT%{mingw64_libdir}
...
%changelog
* Thu Aug 25 2022 Yeti <yeti@gwyddion.net> - 1:2.54.3-5
- added make as BuildRequires
- F36 rebuild

* Wed Mar 23 2022 Yeti <yeti@gwyddion.net> - 1:2.54.3-4
- F34 rebuild

* Tue Feb 23 2021 Yeti <yeti@gwyddion.net> - 1:2.54.3-3
- Multiple definitions build fix (gcc10)
- F33 rebuild

* Fri Feb 19 2021 Yeti <yeti@gwyddion.net> - 1:2.54.3-2
- Disable compile warnings.  They are treated as errors and new GCC
  versions always come with new warnings.
- Started using Epoch

* Thu Oct 25 2018 Yeti <yeti@gwyddion.net> - 2.54.3-1
- Update to 2.54.3
